...
#+BEGIN_SRC sh
  function __laptop_scheme ()
  {
      ...
      elif [ "${AGGREGATOR_SETUP_DONE}" = 1 ]; then
          ZSH_THEME_NEMO_SETUP="aggregator♿ "
          POWERLINE_COLOR_BG_GRAY2=$bg[blue]
          POWERLINE_COLOR_FG_GRAY2=$fg[blue]
      else
